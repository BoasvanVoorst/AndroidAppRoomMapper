...
public class testActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEnableDisable_Discoverable.setEnabled(false);
        ...
        lvNewDevices.setOnItemClickListener(testActivity.this);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if(Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2){
            ...
            mBluetoothConnection = new BluetoothConnectionService(testActivity.this);
        }
    }
